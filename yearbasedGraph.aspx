<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yearbasedGraph.aspx.cs"
                        ...
                        <div>
                            ...
                            <table cellpadding="10" cellspacing="10">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddyear" runat="server" Height="30px" Width="142px">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                            ...
                            <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                Font-Size="XX-Large" ForeColor="#79FFE4" Text="Yearly Rain"></asp:Label>
                            <br />
                            <br />
                            <br />
                            <asp:Chart ID="Chart3" runat="server" Palette="EarthTones" Width="926px">
                                <Series>
