<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prediction3.aspx.cs"
                        ...
                        <div>
                            ...
                            <table cellpadding="10" cellspacing="10">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddmonth" runat="server" Height="30px" Width="142px">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                ...
                                <br />
                                <br />
                                Rain on month of <%=month %> Estimated as <h3><b><%=predict %> </b></h3>
                            <br />
                            <br />
                            <br />
                            <asp:Chart ID="Chart2" runat="server" Palette="EarthTones" Width="632px" Height="241px" style="margin-left: 52px">
                                <Series>
