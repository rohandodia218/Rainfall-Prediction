...
public partial class ResultGraph : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        using (SqlCommand cmd1 = new SqlCommand("select year,avg(rain) as rain from dbo.dataset where islands=@islands and place=@place and year =@year group by year", conn))
        {
