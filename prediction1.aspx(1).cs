...
public partial class ResultGraph : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        using (SqlCommand cmd1 = new SqlCommand("select month,avg(rain) as rain from dbo.dataset where islands=@islands and place=@place and month =@month group by month", conn))
        {
